...
if [ -f "C:/Users/alsrb/go/bin/moai" ]; then
	exec "C:/Users/alsrb/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "C:/Users/alsrb/.local/bin/moai" ]; then
	exec "C:/Users/alsrb/.local/bin/moai" statusline < "$temp_file"
fi
